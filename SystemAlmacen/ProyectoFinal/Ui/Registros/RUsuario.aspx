<%@ Page Title="" Language="C#" MasterPageFile="~/Ui/Registros/Base.Master" AutoEventWireup="true" CodeBehind="RUsuario.aspx.cs" Inherits="ProyectoFinal.Ui.Registros.RUsuario" %>
    ...
    <script src="../../Scripts/popper.min.js"></script>
      ...
      <div class="text-center">
        <span class="btn btn-danger">ID Usuario</span>
            ...
            <asp:Button ID="BotonBuscar" CssClass="btn btn-danger" runat="server" Text="Buscar"  Height="45px" ValidationGroup="Buscar" OnClick="BotonBuscar_Click2"  />
        </div>
             <br />
        ...
        <br />
          ...
          <!--Texbox -->
             ...
             <div class="text-center">
                <asp:Button ID="Button4"  CssClass="btn btn-danger"  runat="server" Text="Nuevo" Height="36px" Width="88px"  ValidationGroup="guardar" OnClick="Button4_Click1" />
                <asp:Button ID="Button2" CssClass="btn btn-danger"  runat="server" Text="Guardar"  Height="36px" Width="88px" ValidationGroup="guardar" OnClick="Button2_Click2"/>
