<%@ Page Title="" Language="C#" MasterPageFile="~/Ui/Base.Master" AutoEventWireup="true" CodeBehind="ConsultaCategoria.aspx.cs" Inherits="ProyectoFinal.Ui.Consultas.ConsultaCategoria" %>
    ...
    <script src="../../Scripts/popper.min.js"></script>
        <header>
            <h1 class="page-header text-center">
                  ...
                  Consulta Categorias <span ></span></h1>
        </header>
